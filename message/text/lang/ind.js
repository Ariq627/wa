...
exports.wait = () => {
    return `Mohon tunggu sebentar jangan request lagi~`
}
...
exports.ownerOnly = () => {
    return `Command ini khusus BOS!`
}

exports.doneOwner = () => {
    return `Sudah selesai, BOS~`
}
...
exports.xvids = (actors, duration, title, url) => {
    return `➸ *pemain*: ${actors}\n➸ *durasi*: ${duration}\n➸ *Title*: ${title}\n➸ *Link*: ${url}`
}
...
Catatan:
Perlakukan bot secara baik, saya akan bertindak tegas apabila user melanggar rules.
...
8. *${prefix}storyig*
Download story ig by username
Aliases: -
Usage: *${prefix}storyig* username
...
15. *${prefix}xvids*
Mencari link by kategori
Aliases: -
Usage: *${prefix}xvids* query (boobs, gisel, jav)

16. *${prefix}xvid*
Mencari video by link
Aliases: - 
Usage: *${prefix}xvid* link 
